    ...
    <div className="mt-7">
      ...
      {!data?.length && (
        <div className="flex items-center justify-center h-[50vh]">
          <div className="flex flex-col items-center gap-4 bg-cards border border-custom_border rounded-xl p-8 shadow-sm text-center">
            ...
            {canCreateProject && (
              <Button
                onClick={() => setOpen(true)}
                className="bg-primary_blue text-white px-4 py-2 text-xs"
              >
                Create Project
              </Button>
            )}
      ...
      {/* ✅ PROJECTS GRID */}
      {data?.length > 0 && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-3 gap-x-20 gap-y-10">
              ...
              <div className="flex justify-between items-center mt-4">
                <Button
                  ...
                  onClick={() => {
                    ...
                    router.push(
                      `/workspaces/${slug}/project/${project.slug}`
                    )
                  }}
                >
                  View Details
